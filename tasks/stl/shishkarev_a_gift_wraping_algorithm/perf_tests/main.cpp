...
TEST(shishkarev_a_gift_wraping_algorithm_stl, test_pipeline_run) {
  ...
  auto test_task_stl = std::make_shared<shishkarev_a_gift_wraping_algorithm_stl::TestTaskSTL>(task_data_stl);
...
TEST(shishkarev_a_gift_wraping_algorithm_stl, test_task_run) {
